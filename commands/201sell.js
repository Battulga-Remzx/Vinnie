...
exports.execute = (client, message, args) => {
  ...
  if (item == "antimatter") {
    ...
    message.channel.send(`You selled ${amount} **ANTIMATTER** +${price.antimatter * amount}`)
    ...
    message.channel.send(`You selled ${amount} **DIAMOND** +${price.diamond * amount}`)
    ...
    message.channel.send(`You selled ${amount} **GOLD** +${price.gold * amount}`)
    ...
    message.channel.send(`You selled ${amount} **IRON** +${price.iron * amount}`)
    ...
    message.channel.send(`You selled ${amount} **COAL** +${price.coal * amount}`)
